                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown no-arrow" >
                            ...
                            <div class="nav-sidebar nav-bar-block nav-collapse" style="width:300px;margin-top: 5px; text-align: center;" id="mySidebar">
                                ...
                                <a href="meja.php?out=keluar" class="nav-bar-item nav-button">Log out</a>
             ...
             <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <!-- Illustrations -->
                        <div class="card shadow col-lg-15 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tambahkan barang</h6>
                            </div>
                            <div class="justify-content-between">
                            <form action="inputdatabaru.php" method="POST">
                                <input type="text" maxlength="30" placeholder="NAMA BARANG..." name="nama" id="nama"><br>
                                <input type="text" maxlength="30" placeholder="JENIS BARANG..." name="jenis" id="jenis"><br>
                                <input type="tel" max="999" maxlength="999" placeholder="JUMLAH BARANG..." name="jumlah" id="jumlah"><br>
                                <input type="tel" maxlength="100" placeholder="HARGA TOTAL..." name="harga" id="harga"><br>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Ambil Barang</h6>
                            </div>
                            <div class="card-body">
                                <form action="output.php" method="POST">
                                <input type="text" maxlength="30" placeholder="NAMA PENERIMA..." name="orang" id="orang"><br>
                                <input type="text" maxlength="30" placeholder="NAMA BARANG..." name="nama" id="nama"><br>
                                <input type="text" maxlength="30" placeholder="JENIS BARANG..." name="jenis" id="jenis"><br>
                                <input type="tel" max="999" maxlength="999" placeholder="JUMLAH BARANG..." name="jumlah" id="jumlah"><br>
                                <input type="tel" maxlength="100" placeholder="HARGA TOTAL..." name="harga" id="harga"><br>
